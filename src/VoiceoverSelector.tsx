...
function VoiceoverItem({deletable}: VideoItemProps, {createElement}:RenderContext) {
    const style= {
        position: 'relative',
        display: 'flex',
        width: 275,
...
export function VoiceoverSelector({}, {createElement}: RenderContext) {
    ...
    return (
        <div>
            ...
            <div>
                <div style={{marginBottom: gaps.large}}>Selected voice</div>
                <div style={videoListStyle}>
                    <VoiceoverItem deletable/>
                    <VoiceoverItem deletable/>
                    <VoiceoverItem deletable/>
                    <VoiceoverItem deletable/>
                    <VoiceoverItem deletable/>
